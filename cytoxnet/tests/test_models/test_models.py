...
class TestToxModel:
    ...
    def test___init__(self):
        ...
        subject = cytoxnet.models.models.ToxModel('GraphCNN', tasks=['y1', 'y2'])
        ...
        subject = cytoxnet.models.models.ToxModel(
            'GPR',
            transformers=[deepchem.trans.NormalizationTransformer(transform_X=True)]
        )
