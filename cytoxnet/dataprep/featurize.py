...
def featurize(dataframe, MolcolumnID='Mol', method='CircularFingerprint'):
    ...
    note: might not need separate featurizer for graph featurization- could include here I think 

    list of possible featurizers to wrap up here: https://deepchem.readthedocs.io/en/latest/api_reference/featurizers.html
    ...
    # molecules format optins-  rdkit.Chem.rdchem.Mol / SMILES string / iterable
